...
public:
    ...
    // Pass skeleton shaders uniform matrices
    void set_bind_mats(std::vector<glm::mat4> &bind_mats);
    void set_overall_trans(std::vector<glm::mat4> &overall_transform);

    // binds vertices (akin to draw(Drawable &d))
    void bind_verts(Mesh &mesh);
