...
void ShaderProgram::create(const char *vertfile, const char *fragfile) {
    ...
    unifOverallTrans = context->glGetUniformLocation(prog, "u_OverallTransform");
}
...
//////////////////////////////////////////////////////////////////////////////
/////////////////////// PASSING in UNIFORM INFORMATION ///////////////////////
//////////////////////////////////////////////////////////////////////////////
void ShaderProgram::set_bind_mats(std::vector<glm::mat4> &bind_mats) {
    useMe();

    glm::mat4 mat_arr[100];
    for (int i = 0; i < bind_mats.size(); i++) {
        mat_arr[i] = bind_mats[i];
    }

    if (unifBindMats != -1) {
        context->glUniformMatrix4fv(unifBindMats, bind_mats.size(),
                                    GL_FALSE, &mat_arr[0][0][0]);
    }
}

void ShaderProgram::set_overall_trans(std::vector<glm::mat4> &overall_transform) {
    useMe();

    glm::mat4 mat_arr[100];
    for (int i = 0; i < overall_transform.size(); i++) {
        mat_arr[i] = overall_transform[i];
    }
...
//////////////////////////////////////////////////////////////////////////////
////////////////// PASSING in INDIVIDUAL VERTEX INFORMATION //////////////////
//////////////////////////////////////////////////////////////////////////////
...
void ShaderProgram::draw(Drawable &d) {
    ...
    if (attrJointID != -1 && d.bindJointIDs()) {
        context->glEnableVertexAttribArray(attrJointID);
        context->glVertexAttribIPointer(attrJointID, 2, GL_INT, 0, NULL);
    }

    if (attrJointWeight != -1 && d.bindJointWeights()) {
        context->glEnableVertexAttribArray(attrJointWeight);
        context->glVertexAttribPointer(attrJointWeight, 2, GL_FLOAT, false, 0, NULL);
    }
